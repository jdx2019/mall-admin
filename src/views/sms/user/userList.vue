    ...
    <div class="table-container">
      <el-table ref="homeAdvertiseTable"
        ...
        <el-table-column label="收货信息" align="center">
          <template slot-scope="scope">{{scope.row.city}}{{scope.row.receiveAddr}}</template>
        </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      getList(pageSize,pageNum) {
        ...
        this.$axios.get('http://hystkj.com:8080/member/list?pageSize='+pageSize+'&pageNum='+pageNum).then(res => {
