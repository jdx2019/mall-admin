  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: {title: '添加优惠券', icon: 'sms-coupon'},
      },
      {
        path: 'updateCoupon',
        name: 'updateCoupon',
        component: () => import('@/views/sms/coupon/update'),
        meta: {title: '修改优惠券', icon: 'sms-coupon'},
      },
      {
        path: 'couponHistory',
        name: 'couponHistory',
        component: () => import('@/views/sms/coupon/history'),
        meta: {title: '优惠券领取详情', icon: 'sms-coupon'},
      },
      {
        path: 'brand',
        name: 'homeBrand',
